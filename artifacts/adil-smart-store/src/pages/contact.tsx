    ...
    <Layout>
      ...
      <section className="bg-[#0D0D0D] border-b border-[#222] py-20 pt-32">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          >
            <div className="inline-block border border-primary/30 text-primary uppercase text-[10px] tracking-[0.3em] px-4 py-1.5 rounded-full mb-6 font-bold bg-[#111]/50">
              CONTACT
            </div>
            <h1 className="font-serif text-5xl md:text-7xl font-black text-white uppercase tracking-tight mb-6">
              Parlons <span className="gold-shimmer">Premium</span>
            </h1>
            <p className="text-[#888] text-sm md:text-base uppercase tracking-widest max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-[#0A0A0A]">
        <div className="container mx-auto px-4 max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-[#111] border border-[#222] p-8 space-y-8 corner-accent relative">
        ...
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 border-y border-[#222] py-12">
            <div className="space-y-2">
              <div className="font-serif text-5xl font-black text-white">500+</div>
              <div className="text-primary text-xs uppercase tracking-[0.2em] font-bold">Clients</div>
            </div>
            <div className="space-y-2">
              <div className="font-serif text-5xl font-black text-white">50+</div>
              <div className="text-primary text-xs uppercase tracking-[0.2em] font-bold">Marques</div>
            </div>
            <div className="space-y-2">
              <div className="font-serif text-5xl font-black text-white">6</div>
      ...
      <section className="py-24 bg-[#0A0A0A] border-t border-[#222]">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-[#111] p-8 border border-[#222] text-center space-y-4 hover:border-primary/50 transition-colors group">
